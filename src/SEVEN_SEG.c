...
const uint8_t SevenSegPattern[16] = {0x3f, 0x06, 0x5b, 0x4f, 0x66, 0x6d, 0x7d, 0x07,
                                     0x7f, 0x6f, 0x40, 0x40, 0x00, 0x00, 0x00, 0x00};
...
void Scan7Segment(void) {
    ...
    if (SEGMENT_Data.SEG_A)
        SEGMENT_1A = 1;
    else
        SEGMENT_1A = 0;
    if (SEGMENT_Data.SEG_B)
        SEGMENT_1B = 1;
    else
        SEGMENT_1B = 0;

    if (SEGMENT_Data.SEG_C)
        SEGMENT_1C = 1;
    else
        SEGMENT_1C = 0;
    if (SEGMENT_Data.SEG_D)
        SEGMENT_1D = 1;
    else
        SEGMENT_1D = 0;

    if (SEGMENT_Data.SEG_E)
        SEGMENT_1E = 1;
    else
        SEGMENT_1E = 0;
    if (SEGMENT_Data.SEG_F)
        SEGMENT_1F = 1;
    else
        SEGMENT_1F = 0;

    if (SEGMENT_Data.SEG_G)
        SEGMENT_1G = 1;
    else
        SEGMENT_1G = 0;
    if (SEGMENT_Data.SEG_DOT)
        SEGMENT_1DOT = 1;
    else
        SEGMENT_1DOT = 0;
