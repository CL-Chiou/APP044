...
const struct {
    ...
    sizeof(sd001), USB_DESCRIPTOR_STRING, {'M', 'i', 'c', 'r', 'o', 'c', 'h', 'i', 'p', ' ', 'T', 'e', 'c',
                                           'h', 'n', 'o', 'l', 'o', 'g', 'y', ' ', 'I', 'n', 'c', '.'}
};
...
const struct {
    ...
    sizeof(sd002), USB_DESCRIPTOR_STRING, {'P', 'r', 'o', 'd', 'u', 'c', 't', ' ', 'N', 'a', 'm', 'e'}
};
...
const uint8_t *const USB_SD_Ptr[USB_NUM_STRING_DESCRIPTORS] = {
    (const uint8_t *const)&sd000, (const uint8_t *const)&sd001, (const uint8_t *const)&sd002};
