...
#define USB_SETUP_HOST_TO_DEVICE_BITFIELD \
    (USB_SETUP_HOST_TO_DEVICE >>          \
     7)  // Device Request bmRequestType transfer direction - host to device transfer - bit definition
#define USB_SETUP_DEVICE_TO_HOST_BITFIELD \
    (USB_SETUP_DEVICE_TO_HOST >>          \
     7)  // Device Request bmRequestType transfer direction - device to host transfer - bit definition
...
#define USB_SETUP_RECIPIENT_DEVICE_BITFIELD \
    (USB_SETUP_RECIPIENT_DEVICE)  // Device Request bmRequestType recipient - device
#define USB_SETUP_RECIPIENT_INTERFACE_BITFIELD \
    (USB_SETUP_RECIPIENT_INTERFACE)  // Device Request bmRequestType recipient - interface
#define USB_SETUP_RECIPIENT_ENDPOINT_BITFIELD \
    (USB_SETUP_RECIPIENT_ENDPOINT)  // Device Request bmRequestType recipient - endpoint
#define USB_SETUP_RECIPIENT_OTHER_BITFIELD \
    (USB_SETUP_RECIPIENT_OTHER)  // Device Request bmRequestType recipient - other
